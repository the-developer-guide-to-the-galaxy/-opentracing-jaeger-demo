package it.tdgttg.opentracing.jaeger.controller.e5;
...
@RestController
@RequestMapping(path = "http-async-hang-up-trace", produces = MediaType.APPLICATION_JSON_VALUE)
public class HttpAsyncHangUpTrace {

	private static final Logger LOGGER = LoggerFactory.getLogger(HttpAsyncHangUpTrace.class);
